...
/**
 * Separate component to fetch and render the gallery content 
 */
...
function GalleryLoader() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
       {[...Array(6)].map((_, i) => (
         <div key={i} className="aspect-[3/2] bg-brand-50 rounded-2xl animate-pulse flex items-center justify-center border border-brand-border">
           <Loader2 className="h-10 w-10 text-brand-primary/10 animate-spin" />
         </div>
       ))}
    </div>
  );
